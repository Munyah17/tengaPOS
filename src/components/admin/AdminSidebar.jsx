...
const NAV_BY_ROLE = {
  super_admin: [
    ...
    { icon: Calculator, label: 'Accounting & ERP Requests', path: '/admin/super/accounting-erp-requests', group: 'TENANTS' },
  ...
  admin: [
    ...
    { icon: Calculator, label: 'Accounting & ERP Requests', path: '/admin/accounting-erp-requests', group: 'OPERATIONS' },
