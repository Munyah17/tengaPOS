...
const plans = [
  ...
  },
  {
    ...
    price: '$150',
    period: 'once-off',
    description: '7.5″ Android Tablet + portable Bluetooth thermal printer + full system access.',
    icon: Tablet,
  ...
  },
  {
    ...
    price: '$200',
    period: 'once-off',
    description: '11.1″ Android Tablet + Bluetooth portable thermal printer + full system access.',
    icon: Monitor,
